...
npm install --save-dev webpack-cliCopy to clipboardErrorCopied
```
...
```sh
npm install --global webpackCopy to clipboardErrorCopied
```
...
npm init -y
npm install webpack webpack-cli --save-devCopy to clipboardErrorCopied
```
...
+   |- index.html
+ |- /src
+   |- index.jsCopy to clipboardErrorCopied
```

- 第二步：安装 loadash 依赖和编写 js 文件

```sh
npm install --save lodashCopy to clipboardErrorCopied
```
...
document.body.appendChild(createDomElement());Copy to clipboardErrorCopied
```
...
```sh
npx webpackCopy to clipboardErrorCopied
```
...
```sh
npm install --save-dev style-loader css-loaderCopy to clipboardErrorCopied
```
...
+   |- style.css
    |- index.js
  |- /node_modulesCopy to clipboardErrorCopied
```
...
```sh
npm install sass-loader node-sass webpack --save-devCopy to clipboardErrorCopied
```
...
$ npm install postcss-import --save-devCopy to clipboardErrorCopied
const path = require('path');
...
```sh
npm install --save-dev mini-css-extract-pluginCopy to clipboardErrorCopied
const path = require('path');
const MiniCssExtractPlugin = require('mini-css-extract-plugin');
...
```sh
npm i -D optimize-css-assets-webpack-pluginCopy to clipboardErrorCopied
const path = require('path');
const MiniCssExtractPlugin = require('mini-css-extract-plugin');
...
```sh
npm i -D uglifyjs-webpack-pluginCopy to clipboardErrorCopied
const path = require('path');
const MiniCssExtractPlugin = require('mini-css-extract-plugin');
...
```sh
npm install --save-dev html-webpack-pluginCopy to clipboardErrorCopied
const path = require('path');
...
```sh
npm install clean-webpack-plugin --save-devCopy to clipboardErrorCopied
```
...
```sh
npm install --save-dev webpack-mergeCopy to clipboardErrorCopied
```
...
```sh
npx webpack --watchCopy to clipboardErrorCopied
```
...
```sh
npm install --save-dev webpack-dev-serverCopy to clipboardErrorCopied
```
...
```sh
webpack-dev-server --openCopy to clipboardErrorCopied
```
...
```sh
npm i -D babel-loader babel-core babel-preset-envCopy to clipboardErrorCopied
```
...
t.show();Copy to clipboardErrorCopied
```
...
npm install babel-runtime --saveCopy to clipboardErrorCopied
```
...
$('.my-element').animate(...);Copy to clipboardErrorCopied
```
...
```sh
npm install --save-dev webpack-bundle-analyzerCopy to clipboardErrorCopied
